...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-mindflow-sky/30 to-mindflow-lavender/30 px-4 py-12">
      {/* Decorative elements */}
      <div className="absolute top-40 left-1/4 w-64 h-64 rounded-full bg-mindflow-mint/20 blur-3xl animate-float" />
      <div className="absolute bottom-20 right-1/4 w-80 h-80 rounded-full bg-mindflow-peach/20 blur-3xl animate-float" style={{ animationDelay: '2s' }} />
